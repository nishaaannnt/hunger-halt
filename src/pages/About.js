...
{/*---card--*/}
    ...
    <div className='flex flex-col'>
        ...
        <div class="aspect-w-16 aspect-h-9 w-screen  px-11  py-4 pt-16">
                 <iframe width="1080" height="560" src="https://www.youtube.com/embed/00dPKd1gu0Q" className="rounded-3xl shadow-2xl" itle="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
             </div>
       </div>
    </div>
    </div>
