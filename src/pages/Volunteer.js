  ...
  return (
    ...
    <div class="volunteer md:flex  justify-center px-12 py-12 items-center h-full mb-16">
        <div class="md:flex justify-center items-center">
            ...
            <div class="image  md:ml-8 md:block">
    ...
    <div class="volunteer md:flex md:justify-center md:px-12 md:py-12  md:items-center md:h-full md:mb-16  max-w-fit md:ml-36">
        ...
        {
            useAppstate.login?
        <VolunteerForm/>:<h1 class="md:text-6xl text-3xl py-3 mb-6 md:mx-auto mx-7 text-hung">Login to be a Volunteer :)</h1>
        }
    </div>
    ...
    <div class="volunteer md:flex  justify-center px-12 py-12 items-center h-full ">
        <div class="md:flex justify-center items-center">
            <div class="desc md:w-1/2 md:mr-9 ">
                <h1 class="md:text-5xl text-3xl py-3 mb-8 text-hung text-center md:text-left">Volunteer Terms and Conditions</h1>
                <p class="md:text-lg mb-8">
        ...
        <div class="volunteer md:flex flex-col justify-center px-12 md:py-12  items-center h-full text-center md:mr-11">
        <h1 class="md:text-5xl text-3xl py-3 mb-8 text-hung text-center ">Support in different way</h1>
